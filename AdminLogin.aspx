<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="BharatSharma05.AdminLogin" %>
...
<body style="background-color:lightyellow;">
    <form id="form1" runat="server">
        <div>
            <br />
            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="XX-Large">Admin Log / Sign Up page</asp:Label>
            <br />
            <br />
            <br />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HRData.aspx.cs" Inherits="BharatSharma05.HRData" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <p>
                &nbsp;</p>
            <asp:Button ID="Button7" runat="server" BackColor="Lime" Font-Bold="True" Text="Previous" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button8" runat="server" BackColor="Lime" Font-Bold="True" Height="26px" Text="Next" Width="51px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button9" runat="server" BackColor="Lime" Font-Bold="True" Height="30px" OnClick="Button9_Click" Text="Add" Width="49px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button10" runat="server" BackColor="Lime" Font-Bold="True" OnClick="Button10_Click" Text="Update" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button11" runat="server" BackColor="Lime" Font-Bold="True" OnClick="Button11_Click" Text="View" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button12" runat="server" BackColor="Lime" Font-Bold="True" OnClick="Button12_Click" Text="Log Out" />
            <br />
            <br />
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            &nbsp;</p>
&nbsp;<asp:Button ID="Button1" runat="server" BackColor="Lime" Font-Bold="True" Text="Previous" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

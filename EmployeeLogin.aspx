<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeLogin.aspx.cs" Inherits="BharatSharma05.EmployeeLogin" %>
...
<body style="background-color:lightyellow;">
    <form id="form2" runat="server">
        <br />
        <br />
            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="XX-Large">Employee Log / Sign Up page</asp:Label>
        <br />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Login" BackColor="Lime" Font-Bold="True" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

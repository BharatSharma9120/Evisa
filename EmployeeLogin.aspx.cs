...
namespace BharatSharma05
{
    public partial class EmployeeLogin : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into emp values('" + TextBox3.Text + "','" + TextBox1.Text
                + "','" + TextBox2.Text + "' )", con);
        ...
        {
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT COUNT(1) FROM emp WHERE id ='" + TextBox3.Text + "'And UserName='" + TextBox1.Text + "'And Password='" + TextBox2.Text + "'", con);

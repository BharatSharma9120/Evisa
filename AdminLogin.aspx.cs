...
namespace BharatSharma05
{
    public partial class AdminLogin : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into admin values('" + TextBox3.Text + "','" + TextBox1.Text
                + "','" + TextBox2.Text + "' )", con);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT COUNT(1) FROM admin WHERE id ='" + TextBox3.Text + "'And UserName='" + TextBox1.Text + "'And Password='" + TextBox2.Text + "'", con);
